...
CREATE TABLE IF NOT EXISTS `system_tec`.`login` (
  ...
  `nickuser` VARCHAR(30) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `senha` VARCHAR(32) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `nivel` ENUM('0', '1', '2', '3') CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `system_tec`.`tb_descricao` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `oat` INT(11) NOT NULL,
  `descricao` VARCHAR(800) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `system_tec`.`users` (
  ...
  `avatar` VARCHAR(350) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL,
  `proprietario` INT(11) NULL DEFAULT NULL,
  `grupoLoja` VARCHAR(2) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL,
  `loja` INT(11) NULL DEFAULT NULL,
  `nivel` ENUM('0', '1', '2', '3', '4') CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL DEFAULT '0',
  `ativo` ENUM('0', '1') CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL DEFAULT '0',
  `data_cadastro` DATE NOT NULL,
  `data_ultimo_login` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `system_tec`.`tb_oat` (
  ...
  `localidade` INT(11) NOT NULL,
  `servico` VARCHAR(6) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `sistema` VARCHAR(12) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `data` DATE NOT NULL,
  `data_sol` DATETIME NOT NULL,
  `filial` INT(2) NULL DEFAULT NULL,
  `os` INT(11) NULL DEFAULT NULL,
  `data_os` DATETIME NULL,
  `data_fech` DATETIME NULL,
  `data_term` DATETIME NULL,
  `status` ENUM('0', '1', '2', '3', '4') CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL DEFAULT '0',
  `ativo` ENUM('0', '1') CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `system_tec`.`tb_teste` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `bem` VARCHAR(500) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 404
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `system_tec`.`tipo_despesa` (
  `id` INT(11) NOT NULL,
  `tipo_despesa` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  `ativo` ENUM('0', '1') CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_unicode_ci;
