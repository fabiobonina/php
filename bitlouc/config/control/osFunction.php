<?php
	...
	require_once '../modal/Os.php';
	require_once '../modal/Servicos.php';
	require_once '../modal/OsTecnicos.php';
	require_once '../modal/Mod.php';
	require_once '../modal/Nota.php';
	require_once '../modal/DeslocStatus.php';
	require_once '../modal/DeslocTrajetos.php';
	require_once '../emailPHP.php';

	class OsFunction extends GlobalControl {
