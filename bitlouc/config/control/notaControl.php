<?php
	require_once 'osControl.php';

	class NotaControl extends OsControl {
		...
		public function osEmail( $os_id ){
			...
			foreach ($os->notas as $value){

				echo $item = '<table width="100%">
							<thead>
								<tr bgcolor="#DADADA">
									<td width="7%"><b>Data</b></td>
									<td width="10%">'. $value['data'] . '</td>
									<td width="7%"><b>Usuario</b></td>
									<td width="50">'.$value['user'] .'</td>
								</tr>
							</thead>
							<tbody>
								<tr>
												...
												<table border="0" cellspacing="1" cellpadding="1" width="100%">
													<tbody>
														...
														<tr height="5%">
															...
															<td width="40%" align="left">'.$os->local_tipo .' - '. $os->local_name. '</td>
														...
														<tr height="5%">
															<td width="10%" align="left"> <b>Localização</b> </td>
															<td width="40%" align="left"> 
																<a href="https://maps.google.com/maps?q='.$os->local_lat.'%2C'.$os->local_long .'&z=17&hl=pt-BR" target="_blank"> Como chegar</a> </td>
															...
															<td colspan="4">
																<table width="100%">
																	<thead>
																		<tr bgcolor="#DADADA">
																			<td width="7%"><b>Data</b></td>
																			<td width="10%">'.$os->os. '</td>
																			<td width="7%"><b>Usuario</b></td>
																			<td width="50">'.$value['tecnico_id'] .'</td>
																		</tr>
																	</thead>
																	<tbody>
																	<tr>
																		<td colspan="4"><b>Descrição</b>'.$os->os. '</td>									
																	</tr>
																	</tbody>
																</table>
																<tr><td colspan="4"><hr></td></tr>
