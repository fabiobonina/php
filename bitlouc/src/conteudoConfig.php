            ...
            <ul class="products-list product-list-in-box">
              <li class="item"  v-for="entry in filteredData">
                ...
                <div class="product-info">
                  ...
                  <span class="pull-right badge bg-blue">Locais: {{ entry.locais.length}} / {{ entry.locais.length}} {{ entry.locais.length}}</span> <span class="label label-warning pull-right">Lacais: {{ entry.locais.length}}</span></a>
                  <span class="product-description">{{entry.name}}</span>
                </div>
              </li>
              <!-- /.item -->
