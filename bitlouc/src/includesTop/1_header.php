...
<nav class="navbar navbar-static-top">
  <div class="container">
    <div class="navbar-header">
      <a href="./index.php" class="navbar-brand"><b>Bit</b>LOUC</a>
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              ...
              <div class="pull-right">
                <a href="?sair" onClick="return confirm('Deseja realmente sair do Sistema?')" class="btn btn-default btn-flat">Sign out</a>
              </div>
            </li>
          </ul>
        </li>
