...
<head>
  ...
  <link href="https://cdnjs.cloudflare.com/ajax/libs/vuetify/1.1.0-alpha.5/vuetify.css" rel="stylesheet">
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, minimal-ui">
  <!-- MATERIALDESINGN ICO -->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/vuetify/1.1.0-alpha.5/vuetify.js"></script>
