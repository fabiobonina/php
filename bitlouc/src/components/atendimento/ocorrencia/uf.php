        ...
        <v-flex v-for=" ocorrencia in oss" :key="ocorrencia.id" v-if=" ocorrencia.ocorrenciaTT > 0" xs4>
          <v-card >
            ...
            <v-list two-line subheader>
              <v-list-tile class="orange lighten-5" :to="'/ocorrencia/uf/' + ocorrencia.id" avatar @click="status = '0'" key="OSs">
                <v-list-tile-avatar>
              ...
              <v-list-tile class="green lighten-5" :to="'/ocorrencia/uf/' + ocorrencia.id" avatar @click="status = '1'">
                <v-list-tile-avatar>
              ...
              <v-list-tile class="cyan lighten-5" :to="'/ocorrencia/uf/' + ocorrencia.id" avatar @click="status = '2'">
                <v-list-tile-avatar>
