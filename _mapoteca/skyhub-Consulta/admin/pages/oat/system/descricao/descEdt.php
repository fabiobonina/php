      <?php
      $resultado = $descricoes->findDesc($descId);
      ?>
      <!-- Small modal -->
      <div class="modal fade modal-descEdt<?php echo $descId; ?>" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <form id="demo-form2" data-parsley-validate method="post" action="" class="form-horizontal form-label-left">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" name="descEdt" class="btn btn-success">Enviar Desc. Serviço</button>
              </div>
            </form>
          </div>
        </div>
